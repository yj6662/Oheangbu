...
def init():
    ...
    save(OUT / 'ledger.json', {'schema': 2, 'started_at': now(), 'original_ledger_sha256': sha(ORIGINAL_LEDGER), 'prior_summon_batches_actual_credits': 205, 'self_imposed_run_cap': CAP,
