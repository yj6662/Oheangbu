...
Last Updated: 2026-09-02 (술식 정본 충실화 Spec 창설·구현 — 광역 cone 실판정 #137·전용 구현 방침 #138, 잔여=예준 게이트)
...
**SPEC-SPELL-FIDELITY: TEST** (2026-09-02 창설 — 전수 감사: CSV 효과문 대 구현 괴리 5건, 문답 전
...
**SPEC-DEV-SPELL-RANGE: TEST** (2026-09-03 창설 — 실플레이 게이트용 사격장 씬 `C1_SpellRange`: 과녁 6(cone
IN 3/OUT 3·거리 6/12m)+실적(F 토글)·바닥 cone 안내선·콘솔 계측[시전/착탄 지연/집계]·R 재시작. 게임 규칙 무접촉
