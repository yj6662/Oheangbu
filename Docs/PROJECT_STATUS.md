...
Last Updated: 2026-08-29 (PR #8 merge · 소 최종 실플레이 통과 → P4 확산 착수)
...
P0~P3 완료·PR #8 머지·소 최종 실플레이 통과. **P4 확산 구현 완료**(2026-08-29, 브랜치 feat/spell-fx-p4):
광역 4자(노 재조합·고 가시 생성·오 파도 생성·모 재조합)+마 아크 항 — 10자 전부 어휘별 시각 분화 배선.
감사 컷 검증·게임 런타임 예외 0·크레딧 −10(잔액 1006). 잔여 = **예준 실플레이 게이트** → P5 통합 검증
(§6 전수·그레이스케일 이중 채널·프로파일러 예산 실측) → Spec PASS 관문
