...
Last Updated: 2026-09-03 (작도 테스트 허브 SPEC-DEV-TEST-HUB 창설 — 리그 프리팹·허브·이펙트 실험실·패링장, 잔여=예준 게이트)
...
**SPEC-DEV-TEST-HUB: TEST** (2026-09-03 창설 — 작도 테스트 허브 `C1_TestHub`: 포탈 4[이펙트 실험실 `C1_EffectLab` 신설·
