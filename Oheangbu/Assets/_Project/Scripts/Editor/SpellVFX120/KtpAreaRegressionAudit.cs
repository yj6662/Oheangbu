...
{
    [InitializeOnLoad] public static class KtpAreaRegressionAudit
    {
        const string Key="KtpAreaRegressionAudit";
        ...
        static KtpAreaRegressionAudit(){EditorApplication.update+=Tick;}
        ...
        static void Tick()
        {
            ...
            File.WriteAllText(Path.Combine(Vfx120Editor.Output,"AreaFive","contact_audit.json"),JsonUtility.ToJson(r,true));EditorApplication.isPlaying=false;
        }
