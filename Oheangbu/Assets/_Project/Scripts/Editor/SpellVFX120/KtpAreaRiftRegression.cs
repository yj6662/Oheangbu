...
{
    [InitializeOnLoad] public static class KtpAreaRiftRegression
    {
        const string Key="KtpAreaRiftRegression";
        ...
        static KtpAreaRiftRegression(){EditorApplication.update+=Tick;}
        ...
        static void Tick()
        {
            ...
            File.WriteAllText(Path.Combine(Vfx120Editor.Output,"AreaRift","contact_audit.json"),JsonUtility.ToJson(r,true));EditorApplication.isPlaying=false;
        }
