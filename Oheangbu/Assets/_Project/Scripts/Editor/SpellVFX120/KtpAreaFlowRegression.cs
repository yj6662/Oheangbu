...
{
    [InitializeOnLoad] public static class KtpAreaFlowRegression
    {
        const string Key="KtpAreaFlowRegression";
        ...
        static KtpAreaFlowRegression(){EditorApplication.update+=Tick;}
        ...
        static void Tick()
        {
            ...
            File.WriteAllText(Path.Combine(Vfx120Editor.Output,"AreaFlow","contact_audit.json"),JsonUtility.ToJson(r,true));EditorApplication.isPlaying=false;
        }
