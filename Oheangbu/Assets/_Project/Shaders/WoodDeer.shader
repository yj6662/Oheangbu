Shader "Oheangbu/WoodDeer"
{
 Properties{
  _BaseMap("Bark color",2D)="white"{}
 ...
 SubShader{
  ...
  Pass{
   ...
   half4 frag(V i):SV_Target{
    ...
    Light l=GetMainLight(TransformWorldToShadowCoord(i.world));float3 ambient=max(SampleSH(n),float3(.19,.19,.19));
