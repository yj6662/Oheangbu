Shader "Oheangbu/VFX120/BambooBolt"
{
    Properties
    {
        ...
        _Build("Cane formation",Range(0,1))=1
        _Dry("Root first drying",Range(0,1))=0
        _Age("Time",Float)=0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                float _BumpScale, _TintStrength, _Saturation, _AlphaClip, _Cutoff, _Visibility, _GroundY, _Formation, _Build, _Dry, _Age;
            CBUFFER_END
            ...
            {
                Varyings o;
                v.positionOS.x+=sin(_Age*11+v.positionOS.z*15)*.007*v.stage.y;
            ...
            half4 Frag(Varyings i, FRONT_FACE_TYPE face:FRONT_FACE_SEMANTIC):SV_Target
            {
                ...
                clip(_Build-.001);clip(_Build-i.progress*.98);clip(i.progress+.01-_Dry+tooth*.05);
                if(_Formation<.9999)
                {
                    clip(_Formation-.001);
