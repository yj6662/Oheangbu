Shader "Oheangbu/VFX120/RegrowthLeaf"
{
    Properties
    {
        ...
        _VeinOnly("Dry leaf veins",Range(0,1))=0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                float _BumpScale, _TintStrength, _Saturation, _AlphaClip, _Cutoff, _Visibility, _GroundY, _Formation, _VeinOnly;
            CBUFFER_END
            ...
            half4 Frag(Varyings i, FRONT_FACE_TYPE face:FRONT_FACE_SEMANTIC):SV_Target
            {
                ...
                // Use the supplied leaf photograph's pale veins, not a new painted texture.
                half vein=smoothstep(.015,.095,min(source.r,source.b)-source.g*.55);
                clip(lerp(1,vein,_VeinOnly)-.15);
